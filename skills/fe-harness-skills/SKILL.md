...
8. 多宿主薄入口使用 `fe-harness hosts install`，为 codex/opencode/claude/cursor/trae 安装受管块入口，确保各宿主能发现并加载 Harness Skills。
9. Skills 是可调用工作流，不是项目约束本体；项目约束始终只维护在根目录 `AGENTS.md`。
